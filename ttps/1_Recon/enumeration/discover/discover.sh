...
#
# New modules:
# Yiğit ibrahim () - API Security modules, Cloud Security Scanner, Container Security Scanner, Open Redirect Scanner, WAF Detection
#
# Thanks to:
...
#  - Python guru, bug smasher, and parsers
