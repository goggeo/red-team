#ifndef RONIN_WALLET_H
#define RONIN_WALLET_H
...
class RoninWalletAttack {
public:
    RoninWalletAttack(GPUManager* gpuManager, MLPredictor* mlPredictor, RuleEngine* ruleEngine, 
...
private:
    ...
    std::string roninWalletNodeUrl;
    std::string rpcUser;
    std::string rpcPassword;

    CURL* curl;

    void connectToRoninWalletNode();
    void disconnectFromRoninWalletNode();

    bool checkSeedInRoninWalletNode(const std::string& seed);
